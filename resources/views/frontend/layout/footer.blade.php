            ...
            <div class="row">
                <div class="col-12 col-md-4">
                    <div class="footer-single-widget">
                        <a href="#"><img src="{{ BASE_URL }}resources/img/core-img/logo.png" alt=""></a>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <script src="{{ BASE_URL }}resources/js/jquery/jquery-2.2.4.min.js"></script>
    <!-- Popper js -->
    ...
    <!-- Active js -->
    <script src="{{ BASE_URL }}resources/js/active.js"></script>
