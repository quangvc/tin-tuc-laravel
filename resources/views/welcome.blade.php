                                            ...
                                            <div class="world-catagory-slider owl-carousel wow fadeInUpBig" data-wow-delay="0.1s">
                                                ...
                                                <div class="single-blog-post">
                                                    ...
                                                    <div class="post-thumbnail">
                                                        <img src="{{ BASE_URL }}public/cover_images/{{ $posts[$i]->cover_image }}" alt="">
                                                        <!-- Catagory -->
                                                        <div class="post-cta"><a href="#">new</a></div>
                                                    </div>
                                                    <!-- Post Content -->
                                                    <div class="post-content">
                                                        <a href="http://127.0.0.1:8080/post/{{ $posts[$i]->id }}" class="headline">
                                                            <h5>{{ $posts[$i]->title }}</h5>
                                                        </a>
                                                        <p>How Did van Gogh’s Turbulent Mind Depict One of the Most Complex Concepts in...</p>
                                                        <!-- Post Meta -->
                                                        <div class="post-meta">
                                                            <p><a href="#" class="post-author">{{ $posts[$i]->user->name }}</a> at <a href="#" class="post-date">{{ $posts[$i]->created_at }}</a></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                @endfor
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="single-blog-post">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                                                    <img src="{{ BASE_URL }}resources/img/blog-img/b1.jpg" alt="">
                                                    <!-- Catagory -->
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="single-blog-post post-style-2 d-flex align-items-center">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                                                    <img src="{{ BASE_URL }}resources/img/blog-img/b10.jpg" alt="">
                                                </div>
                                                <!-- Post Content -->
                                                <div class="post-content">
                                                    <a href="#" class="headline">
                                            ...
                                            <div class="single-blog-post post-style-2 d-flex align-items-center">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                                                    <img src="{{ BASE_URL }}resources/img/blog-img/b11.jpg" alt="">
                                                </div>
                                                <!-- Post Content -->
                                                <div class="post-content">
                                                    <a href="#" class="headline">
                                            ...
                                            <div class="single-blog-post post-style-2 d-flex align-items-center">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                                                    <img src="{{ BASE_URL }}resources/img/blog-img/b12.jpg" alt="">
                                                </div>
                                                <!-- Post Content -->
                                                <div class="post-content">
                                                    <a href="#" class="headline">
                                            ...
                                            <div class="single-blog-post post-style-2 d-flex align-items-center">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                                                    <img src="{{ BASE_URL }}resources/img/blog-img/b13.jpg" alt="">
                                                </div>
                                                <!-- Post Content -->
                                                <div class="post-content">
                                                    <a href="#" class="headline">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="single-blog-post">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                                                    <img src="{{ BASE_URL }}resources/img/blog-img/b2.jpg" alt="">
                                                    <!-- Catagory -->
                                                    <div class="post-cta"><a href="#">travel</a></div>
                                                </div>
                                                <!-- Post Content -->
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="single-blog-post">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                                                    <img src="{{ BASE_URL }}resources/img/blog-img/b3.jpg" alt="">
                                                    <!-- Catagory -->
                                                    <div class="post-cta"><a href="#">travel</a></div>
                                                </div>
                                                <!-- Post Content -->
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="single-blog-post post-style-2 d-flex align-items-center mb-1">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                                                    <img src="{{ BASE_URL }}resources/img/blog-img/b14.jpg" alt="">
                                                </div>
                                                <!-- Post Content -->
                                                <div class="post-content">
                                                    <a href="#" class="headline">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="single-blog-post post-style-2 d-flex align-items-center mb-1">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                                                    <img src="{{ BASE_URL }}resources/img/blog-img/b15.jpg" alt="">
                                                </div>
                                                <!-- Post Content -->
                                                <div class="post-content">
                                                    <a href="#" class="headline">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="single-blog-post post-style-2 d-flex align-items-center mb-1">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                                                    <img src="{{ BASE_URL }}resources/img/blog-img/b16.jpg" alt="">
                                                </div>
                                                <!-- Post Content -->
                                                <div class="post-content">
                                                    <a href="#" class="headline">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="single-blog-post post-style-2 d-flex align-items-center mb-1">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                                                    <img src="{{ BASE_URL }}resources/img/blog-img/b17.jpg" alt="">
                                                </div>
                                                <!-- Post Content -->
                                                <div class="post-content">
                                                    <a href="#" class="headline">
                        ...
                        <div class="sidebar-widget-area">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="single-blog-post post-style-2 d-flex align-items-center widget-post">
                                    ...
                                    <div class="post-content">
                                        <a href="http://127.0.0.1:8080/post/{{ $posts[$i]->id }}" class="headline">
                                            <h5 class="mb-0">{{ $posts[$i]->title }}</h5>
                                        </a>
                                    </div>
                                </div>
                                @endfor
                        ...
                        <div class="sidebar-widget-area">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="single-blog-post todays-pick">
                                    <!-- Post Thumbnail -->
                                    <div class="post-thumbnail">
                                        <img src="{{ BASE_URL }}public/cover_images/{{ $posts[4]->cover_image }}" alt="">
                                    </div>
                                    <!-- Post Content -->
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-blog-post post-style-3 mt-50 wow fadeInUpBig" data-wow-delay="0.2s">
                        <!-- Post Thumbnail -->
                        <div class="post-thumbnail">
                            <img src="{{ BASE_URL }}public/cover_images/{{ $posts[$i]->cover_image }}" alt="" style="height: 226px">
                            <!-- Post Content -->
                            <div class="post-content d-flex align-items-center justify-content-between">
                                ...
                                <!-- Post Meta -->
                                <div class="post-meta">
                                    <p><a href="#" class="post-author">{{ $posts[$i]->user->name }}</a> on <a href="#" class="post-date">{{ $posts[$i]->created_at }}</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <div class="single-blog-post wow fadeInUpBig" data-wow-delay="0.2s">
                            <!-- Post Thumbnail -->
                            <div class="post-thumbnail">
                                <img src="{{ BASE_URL }}resources/img/blog-img/tieng-chuong-chua.jpg" alt="">
                                <!-- Catagory -->
                                <div class="post-cta"><a href="#">video</a></div>
                                <!-- Video Button -->
                                <a href="https://www.youtube.com/watch?v=Tjbdg1emdzo&t=40s" class="video-btn"><i class="fa fa-play"></i></a>
                            </div>
                            <!-- Post Content -->
                            <div class="post-content">
                                <a href="#" class="headline">
                        ...
                        <div class="single-blog-post wow fadeInUpBig" data-wow-delay="0.4s">
                            <!-- Post Thumbnail -->
                            <div class="post-thumbnail">
                                <img src="{{ BASE_URL }}resources/img/blog-img/tieng-chuong-mo-chua.jpg" alt="">
                                <!-- Catagory -->
                                <div class="post-cta"><a href="#">video</a></div>
                                <!-- Video Button -->
                            ...
                            <div class="post-content">
                                <a href="#" class="headline">
                                    <h5>Tiếng chuông mõ chùa - The sound of temple bell</h5>
                                </a>
                                <p>How Did van Gogh’s Turbulent Mind Depict One of the Most Complex Concepts in...</p>
                                <!-- Post Meta -->
                                <div class="post-meta">
